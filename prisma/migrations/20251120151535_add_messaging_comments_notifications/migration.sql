/*
  ...
  - You are about to drop the column `fanId` on the `Notification` table. All the data in the column will be lost.
...
*/
-- DropForeignKey
ALTER TABLE "Notification" DROP CONSTRAINT "Notification_fanId_fkey";

-- DropForeignKey
ALTER TABLE "Notification" DROP CONSTRAINT "Notification_postId_fkey";

-- DropIndex
DROP INDEX "Notification_fanId_idx";

-- AlterTable
ALTER TABLE "Notification" DROP COLUMN "fanId",
DROP COLUMN "message",
DROP COLUMN "postId",
